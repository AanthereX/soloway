        ...
        <div className="overflow-x-auto">
          <table className="table-responsive w-full overflow-auto">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="py-3.5 px-3 text-left text-sm uppercase text-white sm:pl-0"
                >
          ...
          >
            ...
            <tbody className="w-full">
              {blockedProject?.map((project, index) => (
                <>
              ...
              <AvatarGroup
                    ...
                    <td className="px-3 md:px-0 md:text-sm text-[12px]">
                      <p
                        className={
                          "px-2 py-1 bg-c_FF5C5A/20 w-fit text-c_FF5C5A rounded-md"
                        }
                      >
